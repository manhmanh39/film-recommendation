...
experiment_dir = f"../data/sasrec_f_{d_model}_meta_timesplit"
...
model = SASRecF_Concat(max_len=200, num_genres=20, d_model=d_model, n_heads=n_heads, n_layers=n_layers, vocab_size=vocab_size).to(device)
